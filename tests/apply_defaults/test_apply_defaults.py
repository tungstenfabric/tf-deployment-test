...
class ApplyDefaultsTests(WithAttributes, DeploymentTestCase, JujuAction):
    ...
    def test_juju_action_apply_defaults(self):
        ...
        # assert original_juju_encap_priorities.split(",") == original_api_encap_priorities, "ERROR 1_One"

        new_juju_encap_priorities = 'VXLAN'
        ...
        # assert new_juju_encap_priorities.split(",") == current_api_encap_priorities, "ERROR 4_Three"
