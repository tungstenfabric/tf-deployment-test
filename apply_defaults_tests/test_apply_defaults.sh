...
default_encap_priority_prepared=$(python3 $my_dir/tools/get_beauty_encap_value.py $default_encap_priority_raw)
...
new_encap_priority_prepared=$(python3 $my_dir/tools/get_beauty_encap_value.py $new_encap_priority_raw)

echo "we begining set encap_priority = $new_encap_priority_raw"
change_result=$(python3 $my_dir/tools/change_encap_priority.py $node $new_encap_priority_raw)
